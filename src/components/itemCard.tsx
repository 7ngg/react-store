...
const ItemCard = ({ item }: ItemCardProps) => {
  ...
  return (
    <div className="p-2 border border-stone-400 shadow hover:scale-[103%] w-[300px] h-[400px] flex flex-col justify-between gap-4 rounded duration-200 hover:shadow-xl">
